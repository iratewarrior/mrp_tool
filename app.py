...
st.sidebar.warning('Этот инструмент позволяет гибко и точно планировать производство, учитывая текущие остатки, аналоги компонентов и необходимость в дозакупке, что позволяет минимизировать затраты и улучшить управление запасами.')

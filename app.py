...
st.sidebar.warning('Данный инструмент призван помогать в оценивании теущих возможностей производства, учитывая текущие остатки компонентов на складах, а также планировать дозакупку необходимых комопнентов.')
